...
<section class="header">
   ...
   <a href="home.php" class="logo">visit morocco</a>
...
<section class="home-packages">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Marrakesh</h3>
            <p> tour with a travel to Sahara desert</p>
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Chefchaouen</h3>
            <p>Explore The North of Morocco with the blue city vibe in Chefchaouen</p>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="content">
            <h3>Fes</h3>
            <p>Explore the culture of fes and it's architecture </p>
            <a href="book.php" class="btn">book now</a>
         </div>
      </div>
